 ...
 */
class PageView extends BaseModel_1.BaseModel {
    constructor(data = {}) {
        super(data);
    }
    /**
    ...
    static get schema() {
        return joi_1.default.object({
            ...
            title: joi_1.default.string().max(500).allow(null, ''),
            load_time: joi_1.default.number().integer().min(0).allow(null),
            scroll_depth: joi_1.default.number().integer().min(0).max(100).allow(null),
            time_on_page: joi_1.default.number().integer().min(0).allow(null),
    ...
    static async update(id, updates) {
        if (!id)
            throw new Error('Page view ID is required');
        // Validate updates
